...
POSTFIX_CONFIG_DATA="/etc/postfix"
POSTFIX_CONFIG_DATA_MYSQL_VIRTUAL_ALIAS_MAPS="/etc/postfix/mysql-virtual-alias-maps.cf"
POSTFIX_CONFIG_DATA_MYSQL_VIRTUAL_LOGIN_MAPS="/etc/postfix/mysql-virtual-login-maps.cf"
POSTFIX_CONFIG_DATA_MYSQL_VIRTUAL_MAILBOX_DOMAINS="/etc/postfix/mysql-virtual-mailbox-domains.cf"
POSTFIX_CONFIG_DATA_MYSQL_VIRTUAL_MAILBOX_MAPS="/etc/postfix/mysql-virtual-mailbox-maps.cf"
